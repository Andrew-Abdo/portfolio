/*
 * Ce code permet l'utilisation des interruptions externes offerte par le ATmega324P qui sont INT0, INT1 et INT2
 ...
 * 
 * TODO : (quelque suggestions sujetes a discussion en equipe pour le projet final)
 * -Prévoir un déstructeur maybe?? pour desactiver les interruptions
 * -avoir une méthode qui stop les interruptions maybe? (est-ce pertinent)
 * -avoir des methodes publique pour connaitre letat dun boutton interruption (i.e isButtonPressed)
 */
